...
const props = defineProps({
  status: {
    type: String,
    default: 'primary',
    validator: (val) => ['primary', 'info', 'success', 'warning', 'danger', 'basic'].includes(val)
  },
  size: {
    type: String,
    default: 'medium',
...
function getStatusClasses() {
  ...
  if (props.hero) {
    switch (props.status) {
      case 'primary': return 'bg-purple-600 hover:bg-purple-700 text-white shadow-lg';
      case 'info': return 'bg-blue-500 hover:bg-blue-600 text-white shadow-lg';
      case 'success': return 'bg-green-500 hover:bg-green-600 text-white shadow-lg';
      case 'warning': return 'bg-yellow-500 hover:bg-yellow-600 text-white shadow-lg';
      case 'danger': return 'bg-red-500 hover:bg-red-600 text-white shadow-lg';
      default: return 'bg-gray-200 hover:bg-gray-300 text-gray-700 shadow-lg';
    }
  }
  ...
  if (props.outline) {
    switch (props.status) {
      ...
      default: return 'border-2 border-gray-300 text-gray-700 hover:bg-gray-50 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-gray-800';
    }
  }
