...
const props = defineProps({
  ...
  status: {
    type: String,
    default: '',
    validator: (val) => ['', 'success', 'warning', 'danger', 'primary'].includes(val)
  }
});
...
function getRadioStyles() {
  ...
  if (props.modelValue === props.value) {
    ...
    switch (props.status) {
      ...
      case 'primary': return 'bg-purple-600 border-purple-600';
    ...
    switch (props.status) {
      ...
      case 'primary': return 'border-purple-600 hover:bg-purple-100 dark:hover:bg-purple-900/30';
