...
import { RadarChart as EChartsRadarChart, RadarSeriesOption } from 'echarts/charts';
...
type EChartsOption = echarts.ComposeOption<
  TitleComponentOption | LegendComponentOption | TooltipComponentOption | RadarSeriesOption
>;
...
const chartOptions = computed((): EChartsOption => {
  ...
  const baseOptions: EChartsOption = {
    ...
    radar: {
      ...
      splitArea: {
        areaStyle: {
          color: props.darkMode ? 'rgba(255, 255, 255, 0.05)' : 'rgba(0, 0, 0, 0.05)'
        }
      },
      axisLine: {
        lineStyle: {
