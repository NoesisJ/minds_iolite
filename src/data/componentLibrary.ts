...
export const dataComponents: ComponentDefinition[] = [
  {
    ...
    defaultProps: {
      ...
      data: [
        { id: 1, name: "项目一", category: "类别A", value: 100 },
        { id: 2, name: "项目二", category: "类别B", value: 200 },
        { id: 3, name: "项目三", category: "类别A", value: 150 },
        { id: 4, name: "项目四", category: "类别C", value: 300 },
        { id: 5, name: "项目五", category: "类别B", value: 250 },
      ],
      numberFields: ["value"],
      currencyFields: [],
  ...
  },
  {
    ...
    defaultProps: {
      ...
      numberFields: ["age", "salary"],
      currencyFields: ["salary"],
      optionFields: ["department", "position"],
      fieldOptions: {
        department: ['市场部', '研发部', '销售部', '人事部', '财务部', '客服部'],
        position: ['经理', '总监', '主管', '专员', '工程师']
      },
    },
    defaultStyles: {
      width: "100%",
